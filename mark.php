...
<div class="row">
	<div class="col-sm-12 col-md-2 soft-yellow-bg link-section">
		<span data-toggle="tooltip" title="Donate your fresh made or left over food to help the needy labourers who are starving. Mark your location and someone will reach out to you to collect food"><a href="#" id="donate-link" class="t-shadow">Mark donator location</a></span>
		<span data-toggle="tooltip" title="If you know places where there are labourers or people starving in this pandemic, then mark their location and someone will try to provide fooding"><a href="<?=baseurl()?>/request.php" id="request-link">Request food</a></span>
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalCenterTitle">Enter Donating details</h5>
